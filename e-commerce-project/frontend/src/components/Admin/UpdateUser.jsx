...
import { UPDATE_USER_RESET, REMOVE_USER_DETAILS } from '../../../redux/constants/userConstants';
...
const UpdateUser = () => {
    ...
    const { isUpdated, error: updateError, loading: updateLoading } = useSelector((state) => state.userProfile);
    ...
    return (
        <>
            <MetaData title="Admin: Update User | Dashboard" />
